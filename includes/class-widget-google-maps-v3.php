...
class Inventory_Presser_Google_Maps_Widget_V3 extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Embeds a Google Map pointed at a dealership address. Requires an API key.', 'inventory-presser' ), )
		);
	...
	public function widget( $args, $instance )
	{
		...
		wp_add_inline_script( self::ID_BASE, 'const ' . self::ID_BASE . ' = ' . json_encode( array(
			'locations' => $popups,
		) ), 'before' );
	...
	public function form( $instance ) {
		...
		<p><?php _e( 'Choose addresses to mark:', 'inventory-presser' ); ?></p><?php
	 ...
	 */
	protected function get_latitude_and_longitude( $location_term_id )
	{
