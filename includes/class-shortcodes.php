...
class Inventory_Presser_Vehicle_Shortcodes {
	...
	function filter_single_content($content) {
		...
		if (is_singular('inventory_vehicle') && !file_exists(get_template_directory().'/single-inventory_vehicle.php') && !file_exists(get_stylsheet_directory().'/single-inventory_vehicle.php')) {
