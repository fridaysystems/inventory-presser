 ...
 * Primary Branch: main
 * Download URI: https://downloads.wordpress.org/plugin/inventory-presser.15.0.0.zip
 * Download URI: https://inventorypresser.com/wp-content/uploads/inventory-presser-v15.0.0.zip
 */
...
if ( ! defined( 'INVP_PLUGIN_VERSION' ) ) {
	define( 'INVP_PLUGIN_VERSION', '15.0.0' );
}
