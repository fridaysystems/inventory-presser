 ...
 * Primary Branch: main
 * Download URI: https://downloads.wordpress.org/plugin/inventory-presser.14.18.2.zip
 * Download URI: https://inventorypresser.com/wp-content/uploads/inventory-presser-v14.18.2.zip
 */
...
if ( ! defined( 'INVP_PLUGIN_VERSION' ) ) {
	define( 'INVP_PLUGIN_VERSION', '14.18.2' );
}
