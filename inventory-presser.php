 ...
 * Primary Branch: main
 * Download URI: https://downloads.wordpress.org/plugin/inventory-presser.14.18.3.zip
 * Download URI: https://inventorypresser.com/wp-content/uploads/inventory-presser-v14.18.3.zip
 */
...
if ( ! defined( 'INVP_PLUGIN_VERSION' ) ) {
	define( 'INVP_PLUGIN_VERSION', '14.18.3' );
}
...
if ( ! class_exists( 'Inventory_Presser_Plugin' ) ) {
	...
	class Inventory_Presser_Plugin {
		...
		/**
		 * Administrators should always have full control over posts in our
		 * custom post type. No other users will have any capabilities.
		 *
		 * @return void
		 */
		...
		public static function create_post_type() {
			...
			register_post_type(
				...
				apply_filters(
					'invp_post_type_args',
					array(
						'capability_type' => INVP::POST_TYPE,
						'map_meta_cap'    => true,
		...
		public function add_hooks() {
			...
			// Give all administrator users full capabilities over the custom post type.
