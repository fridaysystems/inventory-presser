...
class Inventory_Presser_Plugin
{
	...
	function include_dependencies()
	{
		...
		$file_names = array(
			...
			'shortcodes/class-shortcode-inventory-slider.php',
			'shortcodes/class-shortcode-photo-slider.php',
			'shortcodes/class-shortcode-template-shortcode.php',
			'shortcodes/class-shortcode-archive.php',
			'shortcodes/class-shortcode-archive-vehicle.php',
			'shortcodes/class-shortcode-single-vehicle.php',
			...
			'widgets/class-widget-address.php',
			'widgets/class-widget-carfax.php',
			'widgets/class-widget-fuel-economy.php',
			'widgets/class-widget-google-maps.php',
			'widgets/class-widget-google-maps-v3.php',
			'widgets/class-widget-hours.php',
			'widgets/class-widget-inventory-grid.php',
