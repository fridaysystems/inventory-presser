...
for( const key of invp_blocks.keys )
{
	...
	registerBlockType( 'inventory-presser/' + key['name'].replace( '_', '-' ), { //Block names must include only lowercase alphanumeric characters or dashes and start with a letter.
